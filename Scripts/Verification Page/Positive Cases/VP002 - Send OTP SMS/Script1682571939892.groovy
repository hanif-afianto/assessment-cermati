...
CustomKeywords.'com.cermati.q4.BrowserUtility.clickButton'(findTestObject('verification-page/btn/sendSMS_btn'), FailureHandling.STOP_ON_FAILURE, 'Click Kirim via SMS Button')
